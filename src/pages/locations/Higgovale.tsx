  ...
  return (
    <div className="min-h-screen">
      <SEO
        ...
        description="Premium mobile spa in Higgovale, Cape Town. Mountain-side luxury massage, facials & treatments at your home."
        keywords="mobile spa higgovale, massage higgovale, spa city bowl cape town"
